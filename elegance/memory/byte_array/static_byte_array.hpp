...
namespace face2wind {
	 ...
	 */
	class StaticByteArray : public ByteArray
	{
	...
	public:
		...
		virtual void WriteObject(const void *obj, int bytesLen);

		virtual void ReadFromByteArray(ByteArray *other, int bytesLen = 0);
		...
		template<typename T>
		T ReadItemFromBuffer(T default_val)
		{
			T val;
